...
disp(strcat('Order Of Important Regressors Forward Selection (In orthogonal space) =  ',num2str(num)));
figure
...
teta_hat=inv(((Xtrain_new)')*Xtrain_new)*((Xtrain_new)')*y_ols(1:750,1);
...
disp(strcat('Order Of Important Regressors Forward Selection (In real space) =  ',num2str(num)));
