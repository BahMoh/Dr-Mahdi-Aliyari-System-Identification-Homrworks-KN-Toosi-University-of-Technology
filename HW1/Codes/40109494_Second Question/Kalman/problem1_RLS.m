...
%%maghadir khob: P0=100*eye(5);     if mod(i,100)==0
    %%P0=10^3*eye(5) va P0=10^3*eye(5) baraye reset monasebe; bad az reset, g ro avaz konam behtare
    
%%maghadir khob: P0=1000*eye(5);     if mod(i,100)==0
    %%P0=10^3*eye(5); bad az reset, g ro avaz konam behtare