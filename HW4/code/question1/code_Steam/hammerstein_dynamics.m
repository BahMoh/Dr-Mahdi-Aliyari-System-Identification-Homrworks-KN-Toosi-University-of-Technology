...
Orders = [3*ones(4,11),0*ones(4,11),zeros(4,11)];  %iddata=..*4*11  %%ziad kardan na nb kharab mikone takhir zeros bashe behtare, mishe nb ham zeros gozasht va khata sefid tar mishe (shayad)
