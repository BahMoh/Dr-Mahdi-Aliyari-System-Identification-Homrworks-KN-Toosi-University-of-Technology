...
%% Structure identification of MLP (neuron)
max_epochs = 100;       % Maximum number of epochs
max_hidden = 60;        % Maximum number of hidden layer neurons
...
for num_neuron = 1:max_hidden
    % Defining network
    net = newff(total_P,total_T,num_neuron,{'tansig','purelin'},'trainlm','learngd','mse');
...
% net = newff(total_P(:,1:216),total_T(:,1:216),HiddenLayer_Neurons,{'tansig','purelin'},'trainlm','learngd','mse');
% net.trainParam.epochs = 10;   %% optimum epochs!
% net.dividefcn = '';
% ref_mse = inf;
